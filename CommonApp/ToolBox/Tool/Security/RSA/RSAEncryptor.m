...
- (NSData*) rsaEncryptData:(NSData*)data {
    ...
    for (int i=0; i<blockCount; i++) {
        ...
        NSData *buffer = [data subdataWithRangeCheck:NSMakeRange(i * blockSize, bufferSize)];
...
- (NSData*) rsaDecryptData:(NSData*)data {
    ...
    for (int i=0; i<blockCount; i++) {
        ...
        NSData *buffer = [data subdataWithRangeCheck:NSMakeRange(i * block_size, bufferSize)];
...
+ (NSData *)stripPrivateKeyHeader:(NSData *)d_key{
    ...
    // Now make a new NSData from this buffer
    return [d_key subdataWithRangeCheck:NSMakeRange(idx, c_len)];
}
